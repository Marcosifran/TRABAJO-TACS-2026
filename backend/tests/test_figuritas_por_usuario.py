...
'''
Se cargan figuritas a un usuario como subasta/intercambio_directo
'''
@pytest.fixture
def figuritas_cargadas(client, token_user1):
    """
...
class TestFiguritasPublicadas:
    ...
    def test_usuario_con_figuritas(self, client, token_user1, figuritas_cargadas):
