...
export default function Snackbar({ message, open, onClose, type = 'info' }) {
  ...
  return (
    <div
      className={`fixed bottom-6 left-1/2 z-[100] flex items-center gap-2.5 px-6 py-3.5 rounded-xl text-sm font-medium shadow-elev-3 animate-snack ${TYPE_STYLES[type]}`}
    >
