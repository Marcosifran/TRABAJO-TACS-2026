...
export default function AdminCalificacionesPage() {
  ...
  const hayFiltros =
    filtroCalificador || filtroCalificado || filtroPuntuacion > 0 || filtroComentario
  ...
  const selectClass =
    'bg-surface border border-outline rounded-lg px-3 py-1.5 text-sm text-on-surface focus:outline-primary'
        ...
        <EmptyState
          ...
          subtitle={
            hayFiltros
              ...
              : 'Todavía no se registraron calificaciones'
          }
        />
      ) : (
        <Card>
              ...
              <div key={cal.id} className="flex items-start gap-4 py-4 first:pt-0 last:pb-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-0.5 mt-1.5">
                    ...
                    <span className="ml-1.5 text-xs font-semibold text-on-surface-variant">
                      {cal.puntuacion}/5
                    </span>
                  </div>
                  {cal.comentario ? (
